...
const Menu = () => {
  ...
  useEffect(() => {
    localStorage.removeItem("menuRef");
  }, []);
  ...
  return (
    <>
      <Seo title={t("Online Ordering Retail")} />
      ...
      <Box component="main" sx={{ flexGrow: 1 }}>
        ...
        >
          <Container maxWidth="md">
            {restaurantOpen && groupedData && entities?.total !== 0 && (
              <div>
                <Fab
                  onClick={handleClick}
                  sx={{
                  ...
                  >
                    ...
                    >
                      ...
                      <Input
                        ...
                        fullWidth
                        value={queryText}
                        placeholder={t("Search with product name, code or SKU")}
                        sx={{ flexGrow: 1 }}
                        onChange={(e) => {
                          handleQueryChange(e);
                        }}
