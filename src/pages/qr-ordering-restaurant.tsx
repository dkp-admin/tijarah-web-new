...
const MenuRestaurant = () => {
  ...
  useEffect(() => {
    if (searchParams.get("locationRef")) {
      findMenu(
        `?_q=${debouncedQuery}&orderType=pickup&locationRef=${searchParams.get(
          "locationRef"
  ...
  return (
    <>
      <Seo title={t("QR Ordering Restaurant")} />
            ...
            >
              ...
              >
                <Stack>
                  ...
                  {showOrderType && (
                    <Typography
                      sx={{ ml: 1, mt: 0.5, textTransform: "capitalize" }}
                      variant="subtitle2"
              ...
              <>
                <Box
                  sx={{
                    mt: 0,
                    pt: {
                      xs: showSearch ? 12 : 5.5,
                      sm: showSearch ? 12 : 5.5,
                      md: showSearch ? 14 : 6.5,
                      lg: showSearch ? 14 : 6.5,
                    },
                    pb: 10,
                    display: "flex",
                    flexDirection: "column",
