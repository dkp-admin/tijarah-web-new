    ...
    <Grid container spacing={3}>
      <Grid item lg={3} md={6} sm={12} sx={{ width: "100%" }}>
        <CardWithIconDescription
          ...
          heading={toFixedNumber(inventoryChangeStats?.totalStockAdded || 0.0)}
          description={`Variants: `}
          descriptionValue={toFixedNumber(inventoryChangeStats?.totalVariants || 0.0)}
          showButton={false}
        />
      </Grid>
      ...
      <Grid item lg={3} md={6} sm={12} sx={{ width: "100%" }}>
        <CardWithIconDescription
          ...
          heading={toFixedNumber(inventoryChangeStats?.totalStockRemoved || 0)}
          description={`Net Quantity Change: `}
          descriptionValue={toFixedNumber(inventoryChangeStats?.netQtyChange || 0)}
          showButton={false}
        />
      </Grid>
      ...
      <Grid item lg={3} md={6} sm={12} sx={{ width: "100%" }}>
        <CardWithIconDescription
          ...
          heading={toFixedNumber(inventoryChangeStats?.totalStockRestocked || 0)}
          description={`Net Value Change: `}
          descriptionValue={toFixedNumber(inventoryChangeStats?.netValueChange || 0)}
          showButton={false}
        />
      </Grid>
      ...
      <Grid item lg={3} md={6} sm={12} sx={{ width: "100%" }}>
        <CardWithIconDescription
          ...
          heading={toFixedNumber(inventoryChangeStats?.totalStockSold || 0)}
          description={`Total Product Sold: `}
          descriptionValue={toFixedNumber(inventoryChangeStats?.totalProductSold || 0)}
          showButton={false}
        />
      </Grid>
    </Grid>
