...
interface LowInventoryTopCardProps {
  lowInventoryStats: any;
}

export const LowInventoryReportTopCard: FC<LowInventoryTopCardProps> = (
  props
) => {
  const { t } = useTranslation();
  const { lowInventoryStats } = props;
    ...
    <Grid container spacing={3} sx={{ mt: 3 }}>
      <Grid item lg={3} md={6} sm={12} sx={{ width: "100%" }}>
        <CardWithIconDescription
          ...
          heading={lowInventoryStats?.totalPaymentToday || 0}
      ...
      <Grid item lg={3} md={6} sm={12} sx={{ width: "100%" }}>
        <CardWithIconDescription
          ...
          heading={StyledCurrencyFormatter(
            lowInventoryStats?.todaysTotalAmount?.toFixed(2) || 0.0
          )}
      ...
      <Grid item lg={3} md={6} sm={12} sx={{ width: "100%" }}>
        <CardWithIconDescription
          ...
          heading={lowInventoryStats?.totalRefundToday || 0}
      ...
      <Grid item lg={3} md={6} sm={12} sx={{ width: "100%" }}>
        <CardWithIconDescription
          ...
          heading={StyledCurrencyFormatter(
            lowInventoryStats?.totalRefundAmountToday || 0
          )}
