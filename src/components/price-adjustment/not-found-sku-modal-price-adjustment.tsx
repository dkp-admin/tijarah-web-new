...
interface NotFoundSkuPriceAdjustmentProps {
  open: boolean;
  handleClose?: any;
  handleClear?: any;
  modalData?: any;
...
export const NotFoundSkuPriceAdjustment: React.FC<
  NotFoundSkuPriceAdjustmentProps
> = ({ open, handleClose, handleClear, modalData }) => {
