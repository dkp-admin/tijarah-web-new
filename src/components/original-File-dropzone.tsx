...
interface OgFileDropzoneProps extends DropzoneOptions {
  caption?: string;
  files?: File[];
  imageName: string;
...
export const OgFileDropzone: FC<OgFileDropzoneProps> = (props) => {
  const {
    caption,
    accept,
    files = [],
