...
export const NewImageCropModal: React.FC<ImageCropModalProps> = ({
  open,
  handleClose,
  handleCroppedImage,
  imgSrcUrl,
  ...
  async function onCropClick() {
    ...
    const offscreen = new OffscreenCanvas(cropWidth || 1000, cropHeight || 750);
    ...
    if (origin === "print-template") {
      new Compressor(file, {
        ...
        success(result) {
          ...
          upload([file], fileUploadNameSpace).then((url) => {
