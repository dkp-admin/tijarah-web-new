...
interface SendStocktakesReceiptModalProps {
  open?: boolean;
  handleClose?: () => void;
  modalData?: any;
}

export const SendStocktakesReceiptModal: React.FC<
  SendStocktakesReceiptModalProps
> = ({ open, modalData, handleClose }) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      try {
        const res = await serviceCaller(endpoint.sendStocktakesReceipt.path, {
          method: endpoint.sendStocktakesReceipt.method,
          body: {
            order: modalData,
