...
function LocationsTab({ origin = "company" }) {
      ...
      <Card sx={{ my: 4 }}>
        <CardContent>
          <Grid container>
            <Grid xs={12} md={8}>
              <Stack spacing={1}>
                <Typography variant="h6">{t("Create Location")}</Typography>
                <Typography color="text.secondary" variant="body2">
                  {t("Locations of the company can be managed here")}
                </Typography>
              </Stack>
            </Grid>
            <Grid xs={12} md={4}>
...
export default withPermission(LocationsTab, MoleculeType["location:read"]);
